...
export function Calendar({ view = 'month', date, events, onDateChange, onViewChange, onEventClick, onSlotClick, weekStartsOn = 0, locale = 'en-US', labels: labelOverrides, className, renderEvent, }) {
    ...
    return (_jsxs("div", { "data-slot": "calendar", className: cn('@container/calendar flex flex-col gap-3', className), children: [_jsx(CalendarToolbar, { date: date, view: view, onPrev: handlePrev, onNext: handleNext, onToday: handleToday, onViewChange: onViewChange ? handleViewChange : undefined, locale: locale, labels: labels }), view === 'month' ? (_jsx(MonthView, { ...sharedProps, weekStartsOn: weekStartsOn, onDateClick: onDateChange ? (d) => onDateChange(d) : undefined })) : view === 'week' ? (_jsx(WeekView, { ...sharedProps, weekStartsOn: weekStartsOn, onDateClick: onDateChange ? (d) => onDateChange(d) : undefined })) : (_jsx(DayView, { ...sharedProps }))] }));
}
