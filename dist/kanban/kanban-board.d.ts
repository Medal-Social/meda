 ...
 */
export declare function KanbanBoard<TItem extends KanbanItem, TStatus extends string>({ columns, items, renderCard, onReorder, onCardMove, canDropCard, onAddItem, showEmptyColumns, hiddenColumnIds, onHiddenColumnIdsChange, isLoading, emptyColumnContent, labels, }: KanbanBoardProps<TItem, TStatus>): import("react/jsx-runtime").JSX.Element;
